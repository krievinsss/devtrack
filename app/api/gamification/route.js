...
const equippedSchema=z.object({avatar_frame:z.string().nullable().optional(),title:z.string().nullable().optional(),slug:z.string().nullable().optional(),ui_theme:z.string().nullable().optional()}).partial();
