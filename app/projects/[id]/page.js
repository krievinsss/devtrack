...
export default async function Project({params}){
  ...
  return <AppShell user={user}><ProjectWorkspace project={project} assignment={assignment} formative={formative} summative={summative} student={student} commits={commits} feedback={feedback} assessment={assessment} review={review} tree={tree} defaultFile={defaultFile} githubError={githubError} series={weeklySeries(commits)} heatmap={contributionDays(commits)} attendance={attendance} user={user}/></AppShell>
}
