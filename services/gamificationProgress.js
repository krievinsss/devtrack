...
export async function evaluateGamificationProgress(studentId){
  const [projects,commits,attendance,assessments]=await Promise.all([readJson('projects',[]),readJson('commits',[]),readJson('attendance',[]),readJson('assessments',[])]);
